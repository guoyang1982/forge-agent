...
export function createAssetsModule(): DaemonModule<ForgeDaemonContext> {
  return {
    ...
    register(router, context) {
      ...
      router.registerLegacy(DAEMON_METHODS.LIST_PLUGINS, async (params) =>
        handleListPlugins(params, runtimeFiles));
      router.registerLegacy(DAEMON_METHODS.LIST_SKILLS, async (params) =>
        handleListSkills(params, { getRuntime: context.getRuntime }));
      router.registerLegacy(DAEMON_METHODS.LIST_MCP, async (params) =>
        handleListMcp(params, runtimeFiles));
      router.registerLegacy(DAEMON_METHODS.GET_CONFIG, async (params) =>
        handleGetConfig(params));
      router.registerLegacy(DAEMON_METHODS.RELOAD_RUNTIME, async () =>
        context.reloadRuntime());
      router.registerLegacy(DAEMON_METHODS.SEARCH_CATALOG, async (params) =>
        handleSearchCatalog(params));
      router.registerLegacy(DAEMON_METHODS.SEARCH_SKILLS_MARKETPLACE, async (params) =>
        handleSearchSkillsMarketplace(params));
      router.registerLegacy(DAEMON_METHODS.SEARCH_PLUGINS_MARKETPLACE, async (params) =>
        handleSearchPluginsMarketplace(params));
      router.registerLegacy(DAEMON_METHODS.HUB_LIST, async (params) =>
        handleHubList(params, data));
      router.registerLegacy(DAEMON_METHODS.HUB_INSTALL, async (params) =>
        mutateAndReload(() => handleHubInstall(params, data), context));
      router.registerLegacy(DAEMON_METHODS.HUB_DEPLOY, async (params) =>
        mutateAndReload(() => handleHubDeploy(params, data), context));
      router.registerLegacy(DAEMON_METHODS.HUB_UNDEPLOY, async (params) =>
        mutateAndReload(() => handleHubUndeploy(params, data), context));
      router.registerLegacy(DAEMON_METHODS.HUB_REMOVE, async (params) =>
        mutateAndReload(() => handleHubRemove(params, data), context));
      router.registerLegacy(DAEMON_METHODS.HUB_SYNC, async (params) =>
        mutateAndReload(() => handleHubSync(params, data), context));
      router.registerLegacy(DAEMON_METHODS.HUB_DISCOVER, async (params) =>
        handleHubDiscover(params, data));
      router.registerLegacy(DAEMON_METHODS.HUB_IMPORT, async (params) =>
        mutateAndReload(() => handleHubImport(params, data), context));
      router.registerLegacy(DAEMON_METHODS.SET_SKILL_ENABLED, async (params) =>
        handleSetSkillEnabled(params));
      router.registerLegacy(DAEMON_METHODS.SET_PLUGIN_ENABLED, async (params) =>
        handleSetPluginEnabled(params));
      router.registerLegacy(DAEMON_METHODS.IMPORT_SKILL, async (params) =>
        mutateAndReload(() => handleImportSkill(params, data), context));
      router.registerLegacy(DAEMON_METHODS.IMPORT_PLUGIN, async (params) =>
...
function registerTalentMethods(
  ...
  router.registerLegacy(DAEMON_METHODS.TALENTS_SYNC_TEMPLATES, async (params) =>
    handleTalentSyncTemplates(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_LIST_TEMPLATES, async (params) =>
    handleListTalentTemplates(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_HIRE, async (params) =>
    handleHireTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_FIRE, async (params) =>
    handleFireTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_LIST_ROSTER, async (params) =>
    handleListTalentRoster(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_RENAME, async (params) =>
    handleRenameTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_UPDATE_BINDINGS, async (params) =>
    handleUpdateTalentBindings(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_GET_TEMPLATE, async (params) =>
    handleGetTalentTemplate(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_CREATE_CUSTOM, async (params) =>
    handleCreateCustomTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_UPDATE_CUSTOM, async (params) =>
    handleUpdateCustomTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_DELETE_CUSTOM, async (params) =>
    handleDeleteCustomTalent(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_LIST_TEAMS, async (params) =>
    handleListTalentTeams(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_CREATE_TEAM, async (params) =>
    handleCreateTalentTeam(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_UPDATE_TEAM, async (params) =>
    handleUpdateTalentTeam(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_DELETE_TEAM, async (params) =>
    handleDeleteTalentTeam(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_LIST_AGENT_RUNS, async (params) =>
    handleListTalentAgentRuns(params, data));
  router.registerLegacy(DAEMON_METHODS.TALENTS_LIST_AGENT_MEMORY, async (params) =>
